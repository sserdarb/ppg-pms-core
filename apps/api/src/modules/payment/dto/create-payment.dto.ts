...
export class CreatePaymentDto {
  ...
  @ApiProperty({ enum: ['credit_card', 'debit_card', 'cash', 'bank_transfer', 'city_ledger', 'vcc', 'instapay', 'other'] })
  @IsEnum(['credit_card', 'debit_card', 'cash', 'bank_transfer', 'city_ledger', 'vcc', 'instapay', 'other'])
  method!: string;
