...
export const properties = pgTable('properties', {
  ...
  // PPG control-plane provenance — set by /admin/tenants when activated from
  // the PPG master panel; null for properties created via the public POST.
  externalId: varchar('external_id', { length: 100 }),
  provisionedBy: varchar('provisioned_by', { length: 50 }),
